...
type StatusFilter = "draft" | "active" | "rejected" | "";
              ...
              <div key={qId} className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200/80 hover:border-indigo-200 hover:shadow-md transition-all shadow-sm">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mt-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2 shrink-0">
                    ...
                    <button
                      onClick={() => setHistoryQuestionId(qId)}
                      title="View history"
                      className="p-2 bg-slate-50 hover:bg-slate-200 text-slate-500 border border-slate-200 rounded-xl transition-all cursor-pointer"
                    >
