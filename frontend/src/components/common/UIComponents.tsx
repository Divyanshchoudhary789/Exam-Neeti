...
export const IconTrendingUp = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8.5 8.5-5-5L3 15" />
  </svg>
);

export const IconRocket = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 15.5c-3.5 0-6.5-1.5-8-4.5 1-4.5 4.5-8.5 9.5-9.5 3 1.5 5.5 4.5 6.5 8-1 4.5-4 7-8 6zm-4.5-1.5L4 17.5m12.5-3l3.5 3.5M8 16l-1 4.5M16 16l1 4.5" />
  </svg>
);

export const IconBulb = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 18h6m-5 3h4m-2-19a6 6 0 00-3.5 10.9c.5.4.9 1 .9 1.7v.4h5.2v-.4c0-.7.4-1.3.9-1.7A6 6 0 0012 2z" />
  </svg>
);

export const IconThumbsUp = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M14 9V5a2 2 0 00-2-2l-3 7v10h9.28a2 2 0 002-1.7l1.14-7A2 2 0 0019.44 9H14zM7 22H4a1 1 0 01-1-1v-9a1 1 0 011-1h3v11z" />
  </svg>
);

export const IconBuilding = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 21h18M6 21V5a1 1 0 011-1h10a1 1 0 011 1v16M9 9h1m4 0h1m-6 4h1m4 0h1m-6 4h1m4 0h1" />
  </svg>
);

export const IconGraduationCap = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.42A9 9 0 0121 12v3m-9-1v6m0 0c-2.21 0-4-1.79-4-4v-2l4-2 4 2v2c0 2.21-1.79 4-4 4z" />
  </svg>
);
...
// Google's official 4-color "G" mark — used only for the "Continue with Google" button.
export const IconGoogle = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24">
    ...
    <path fill="#FBBC05" d="M5.27 14.28A7.2 7.2 0 014.9 12c0-.79.14-1.56.37-2.28V6.63H1.28A12 12 0 000 12c0 1.94.46 3.77 1.28 5.37l3.99-3.09z" />
    <path fill="#EA4335" d="M12 4.77c1.77 0 3.35.61 4.6 1.8l3.42-3.42C17.95 1.19 15.24 0 12 0 7.31 0 3.26 2.69 1.28 6.63l3.99 3.09C6.22 6.88 8.87 4.77 12 4.77z" />
  </svg>
);
